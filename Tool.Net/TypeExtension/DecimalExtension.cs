...
namespace Tool
{
    ...
    public static class DecimalExtension
    {
        ...
        public static int ToInt(this decimal txt , bool type = false)
        {
        ...
        //public static byte[] ToBytes(this decimal txt)
        //{
        //    //if (txt == 0)
        //    //{
        ...
        public static decimal[] Add(this decimal[] txt, decimal txt1)
        {
            var add = txt.ToList();
            add.Add(txt1);
            txt = add.ToArray();
        ...
        public static bool Contains(this decimal[] txt, decimal txt1)
        {
            return txt.Contains<decimal>(txt1);
        }
        ...
        public static decimal[] GetArrayIndex(this decimal[] obj, int index, int count)
        {
            if (obj == null)
            {
                throw new System.SystemException("该decimal为空！");
            }
            if (index > count)
            {
