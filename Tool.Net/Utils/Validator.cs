...
namespace Tool.Utils
{
    ...
    public class Validator
    {
        ...
        /// 非零的正整数
        /// </summary>
        public const string reg10 = @"^[1-9]\d*$";// 或 ^([1-9][0-9]*){1,3}$ 或 ^\+?[1-9][0-9]*$
        /// <summary>
        /// 非零的正整数
        /// </summary>
        public const string reg10_1 = @"^([1-9][0-9]*){1,3}$";// 或 ^([1-9][0-9]*){1,3}$ 或 ^\+?[1-9][0-9]*$
        /// <summary>
        /// 非零的正整数
        /// </summary>
        public const string reg10_2 = @"^\+?[1-9][0-9]*$";// 或 ^([1-9][0-9]*){1,3}$ 或 ^\+?[1-9][0-9]*$
        /// <summary>
        /// 非零的负整数
        /// </summary>
        public const string reg11 = @"^\-[1-9][]0-9″*$";// 或 ^-[1-9]\d*$
        /// <summary>
        /// 非零的负整数
        /// </summary>
        public const string reg11_1 = @"^-[1-9]\d*$";// 或 ^-[1-9]\d*$
        /// <summary>
        /// 非负整数
        /// </summary>
        public const string reg12 = @"^\d+$";// 或 ^[1-9]\d*|0$
        /// <summary>
        /// 非负整数
        /// </summary>
        public const string reg12_1 = @"^[1-9]\d*|0$";// 或 ^[1-9]\d*|0$
        /// <summary>
        /// 非正整数
        /// </summary>
        public const string reg13 = @"^-[1-9]\d*|0$";// 或 ^((-\d+)|(0+))$
        /// <summary>
        /// 非正整数
        /// </summary>
        public const string reg13_1 = @"^((-\d+)|(0+))$";// 或 ^((-\d+)|(0+))$
        /// <summary>
        /// 非负浮点数
        /// </summary>
        public const string reg14 = @"^\d+(\.\d+)?$";// 或 ^[1-9]\d*\.\d*|0\.\d*[1-9]\d*|0?\.0+|0$
        /// <summary>
        /// 非负浮点数
        /// </summary>
        public const string reg14_1 = @"^[1-9]\d*\.\d*|0\.\d*[1-9]\d*|0?\.0+|0$";// 或 ^[1-9]\d*\.\d*|0\.\d*[1-9]\d*|0?\.0+|0$
        /// <summary>
        /// 非正浮点数
        /// </summary>
        public const string reg15 = @"^((-\d+(\.\d+)?)|(0+(\.0+)?))$";// 或 ^(-([1-9]\d*\.\d*|0\.\d*[1-9]\d*))|0?\.0+|0$
        /// <summary>
        /// 非正浮点数
        /// </summary>
        public const string reg15_1 = @"^(-([1-9]\d*\.\d*|0\.\d*[1-9]\d*))|0?\.0+|0$";// 或 ^(-([1-9]\d*\.\d*|0\.\d*[1-9]\d*))|0?\.0+|0$
        /// <summary>
        /// 正浮点数
        /// </summary>
        public const string reg16 = @"^[1-9]\d*\.\d*|0\.\d*[1-9]\d*$";// 或 ^(([0-9]+\.[0-9]*[1-9][0-9]*)|([0-9]*[1-9][0-9]*\.[0-9]+)|([0-9]*[1-9][0-9]*))$
        /// <summary>
        /// 正浮点数
        /// </summary>
        public const string reg16_1 = @"^(([0-9]+\.[0-9]*[1-9][0-9]*)|([0-9]*[1-9][0-9]*\.[0-9]+)|([0-9]*[1-9][0-9]*))$";// 或 ^(([0-9]+\.[0-9]*[1-9][0-9]*)|([0-9]*[1-9][0-9]*\.[0-9]+)|([0-9]*[1-9][0-9]*))$
        /// <summary>
        /// 负浮点数
        /// </summary>
        public const string reg17 = @"^-([1-9]\d*\.\d*|0\.\d*[1-9]\d*)$";// 或 ^(-(([0-9]+\.[0-9]*[1-9][0-9]*)|([0-9]*[1-9][0-9]*\.[0-9]+)|([0-9]*[1-9][0-9]*)))$
        /// <summary>
        /// 负浮点数
        /// </summary>
        public const string reg17_1 = @"^(-(([0-9]+\.[0-9]*[1-9][0-9]*)|([0-9]*[1-9][0-9]*\.[0-9]+)|([0-9]*[1-9][0-9]*)))$";// 或 ^(-(([0-9]+\.[0-9]*[1-9][0-9]*)|([0-9]*[1-9][0-9]*\.[0-9]+)|([0-9]*[1-9][0-9]*)))$
        /// <summary>
        /// 浮点数
        /// </summary>
        public const string reg18 = @"^(-?\d+)(\.\d+)?$";// 或 ^-?([1-9]\d*\.\d*|0\.\d*[1-9]\d*|0?\.0+|0)$
        /// <summary>
        /// 浮点数
        /// </summary>
        public const string reg18_1 = @"^-?([1-9]\d*\.\d*|0\.\d*[1-9]\d*|0?\.0+|0)$";// 或 ^-?([1-9]\d*\.\d*|0\.\d*[1-9]\d*|0?\.0+|0)$
        #endregion
        ...
        /// 英文和数字
        /// </summary>
        public const string reg20 = @"^[A-Za-z0-9]+$";// 或 ^[A-Za-z0-9]{4,40}$
        /// <summary>
        /// 英文和数字
        /// </summary>
        public const string reg20_1 = @"^[A-Za-z0-9]{4,40}$";// 或 ^[A-Za-z0-9]{4,40}$
        /// <summary>
        /// 长度为3-20的所有字符
        /// </summary>
        ...
        /// </summary>
        public const string reg26 = @"^\w+$";// 或 ^\w{3,20}$
        /// <summary>
        /// 由数字、26个英文字母或者下划线组成的字符串
        /// </summary>
        public const string reg26_1 = @"^\w{3,20}$";// 或 ^\w{3,20}$
        /// <summary>
        /// 中文、英文、数字包括下划线
        /// </summary>
        ...
        /// 中文、英文、数字但不包括下划线等符号
        /// </summary>
        public const string reg28 = @"^[\u4E00-\u9FA5A-Za-z0-9]+$";// 或 ^[\u4E00-\u9FA5A-Za-z0-9]{2,20}$
        /// <summary>
        /// 中文、英文、数字但不包括下划线等符号
        /// </summary>
        public const string reg28_1 = @"^[\u4E00-\u9FA5A-Za-z0-9]{2,20}$";// 或 ^[\u4E00-\u9FA5A-Za-z0-9]{2,20}$
        /// <summary>
        /// 可以输入含有^%’,;=?$\”等字符
        /// </summary>
        ...
        /// InternetURL
        /// </summary>
        public const string reg33 = @"[a-zA-z]+://[^\s]*";// 或 ^http://([\w-]+\.)+[\w-]+(/[\w-./?%&=]*)?$
        /// <summary>
        /// InternetURL
        /// </summary>
        public const string reg33_1 = @"^http://([\w-]+\.)+[\w-]+(/[\w-./?%&=]*)?$";// 或 ^http://([\w-]+\.)+[\w-]+(/[\w-./?%&=]*)?$
        /// <summary>
        /// 手机号码
        /// </summary>
        ...
        /// 短身份证号码(数字、字母x结尾)
        /// </summary>
        public const string reg38 = @"^([0-9]){7,18}(x|X)?$";// 或 ^\d{8,18}|[0-9x]{8,18}|[0-9X]{8,18}?$
        /// <summary>
        /// 短身份证号码(数字、字母x结尾)
        /// </summary>
        public const string reg38_1 = @"^\d{8,18}|[0-9x]{8,18}|[0-9X]{8,18}?$";// 或 ^\d{8,18}|[0-9x]{8,18}|[0-9X]{8,18}?$
        /// <summary>
        ...
        /// </summary>
        public const string reg55 = @"[^\x00-\xff]";// (包括汉字在内，可以用来计算字符串的长度(一个双字节字符长度计2，ASCII字符计1))
        /// <summary>
        /// 空白行的正则表达式，可用来删除空白行
        /// </summary>
        ...
        /// HTML标记的正则表达式
        /// </summary>
        public const string reg57 = @"<(\S*?)[^>]*>.*?</\1>|<.*? />";// (网上流传的版本太糟糕，上面这个也仅仅能部分，对于复杂的嵌套标记依旧无能为力)
        /// <summary>
        /// 首尾空白字符的正则表达式
        /// </summary>
        public const string reg58 = @"^\s*|\s*$)";//或(^\s*)|(\s*$ (可以用来删除行首行尾的空白字符(包括空格、制表符、换页符等等)，非常有用的表达式)
        /// <summary>
        /// 首尾空白字符的正则表达式
        /// </summary>
        public const string reg58_1 = @"(^\s*)|(\s*$";//或(^\s*)|(\s*$ (可以用来删除行首行尾的空白字符(包括空格、制表符、换页符等等)，非常有用的表达式)
        /// <summary>
        /// 腾讯QQ号
        /// </summary>
        public const string reg59 = @"[1-9][0-9]{4,}";//(腾讯QQ号从10000开始)
        /// <summary>
        /// 中国邮政编码
        /// </summary>
        public const string reg60 = @"[1-9]\d{5}(?!\d)";// (中国邮政编码为6位数字)
        /// <summary>
        /// IP地址
        /// </summary>
        public const string reg61 = @"\d+\.\d+\.\d+\.\d+";// (提取IP地址时有用)
        /// <summary>
        /// IP地址
        /// </summary>
