...
namespace Tool.Sockets.UdpHelper.Extend
{
    internal class UdpPack : IUdpCore
    {
        ...
        internal UdpPack(INetworkCore networkCore, UdpEndPoint endPoint, Socket socket, int dataLength, bool onlyData, bool isserver, bool isp2p, Func<UserKey, byte, ValueTask> complete, ReceiveEvent<IUdpCore> received)
        {
        ...
        async Task IUdpCore.ReceiveAsync(Memory<byte> memory) //原模式完全还原原始效果，优化了多个连接者缓冲区增大
        {
