...
namespace Tool.Sockets.NetFrame
{
    ...
    public class NetResponse
    {
        ...
        /// 无参构造
        /// </summary>
        public NetResponse(string onlyID)
        {
            OnlyID = onlyID;
        }
        ...
        /// 用于表示当前数据包的执行情况
        /// </summary>
        public NetFrameState OnNetFrame { get; internal set; } = NetFrameState.Default;
        ...
        {
            OnNetFrame = packet.IsErr ? NetFrameState.Exception : NetFrameState.Success;
            if (!packet.IsErr)
            {
                Text = packet.Text;
